...
public class LandscapeGenerator : MonoBehaviour
{
    ...
    private TextureDisplay _textureDisplay;
    ...
    public void GenerateTerrain()
    {
        ...
        _water.position = new Vector3(0, _seaLevel, 0);
        _water.localScale = new Vector3(_worldSize * _meshSizeX / 10 + 10, 1, _worldSize * _meshSizeY / 10 + 10);
